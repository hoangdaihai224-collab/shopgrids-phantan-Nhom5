...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 01, 2025 lúc 05:17 PM
...
--
-- Cơ sở dữ liệu: `electronicedevice`
--
...
(5, '2021_09_02_145021_create_tbl_category_table', 1),
(6, '2021_09_04_090659_create_tbl_useradmin_table', 2),
(7, '2021_09_04_130442_create_tbl_useradmin_table', 3),
(8, '2021_09_06_062041_create_tbl_color_table', 4),
(9, '2021_09_06_062055_create_tbl_brand_table', 4),
(10, '2021_09_06_084038_create_tbl_procolor_table', 5),
(11, '2021_09_06_084827_create_tbl_product_table', 6),
(12, '2021_09_06_090023_create_tbl_product_table', 7),
(13, '2021_09_06_141945_create_tbl_productimg_table', 8),
(14, '2021_09_07_145648_create_tbl_cart_table', 9),
(15, '2021_09_08_132526_create_tbl_banner_table', 10);
...
INSERT INTO `tbl_banner` (`id`, `title`, `image`, `url`, `target`, `description`, `type`, `position`, `status`, `created_at`, `updated_at`) VALUES
(3, 'M75 Sport Watch', '1632967092-30-09-2021-NSWCFXPTKG.jpg', 'http://localhost:8080/electronice/Product-detail/54', 'No restocking fee ($35 savings)', '<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum eveniet impedit sapiente adipisci, ea error omnis corrupti. Quia consectetur labore enim excepturi! Aliquid, quisquam dolorum impedit officia ad optio rerum.</p><h3 style=\"margin: 20px 0px 0px; font-weight: 800; font-size: 25px; font-family: Manrope, sans-serif; padding: 0px; color: rgb(8, 24, 40);\"><span style=\"margin: 0px 12px 0px 0px; padding: 0px; display: inline-block; transition: all 0.4s ease 0s; font-size: 16px; color: rgb(138, 138, 138);\">Now Only</span>&nbsp;$320.99</h3>', 1, 1, 1, '2021-09-29 18:58:12', '2021-10-07 02:12:51'),
(4, 'Noã restocking fee ($35 savings) giảm 50%', '1632967576-30-09-2021-EVWSASSXNN.jpg', 'http://localhost:8080/electronice/Product-detail/54', 'Big Sale Offer', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><h3 style=\"margin: 20px 0px 0px; padding: 0px; font-weight: 800; font-size: 25px; color: rgb(8, 24, 40); font-family: Manrope, sans-serif;\"><span style=\"margin: 0px 12px 0px 0px; padding: 0px; display: inline-block; transition: all 0.4s ease 0s; font-size: 16px; color: rgb(138, 138, 138);\">Combo Only:</span>&nbsp;$590.00</h3>', 1, 2, 1, '2021-09-29 19:06:16', '2021-10-07 02:12:58'),
(5, 'iPhone 12 Pro Max', '1632967636-30-09-2021-ILODOYHCPR.jpg', 'http://localhost:8080/electronice/Product-detail/7', 'New line required', '$259.99', 2, 1, 1, '2021-09-29 19:07:16', '2021-09-29 19:07:49'),
(6, 'Weekly Sale!', '1632967723-30-09-2021-JSLORO6BC4.png', 'http://localhost:8080/electronice/Product-detail/7', 'Saving up to 50% off all online store items this week.', 'không có gì', 3, 1, 1, '2021-09-29 19:08:43', '2021-09-29 19:09:09'),
(7, 'Samsung Notebook 9', '1633615183-07-10-2021-2HYOQVCDDK.jpg', 'http://localhost:8080/electronice/Product-detail/53', '$590.00', '<p>Lorem ipsum dolor sit amet,</p><p>eiusmod tempor incididunt ut labore.</p>', 5, 1, 1, '2021-10-07 06:59:43', '2021-10-07 07:00:42');
...
INSERT INTO `tbl_blog` (`id`, `blog_title`, `blog_image`, `blog_conten`, `blog_summary`, `category`, `status`, `created_at`, `updated_at`) VALUES
(2, 'What information is needed for shipping?', '1631958976-18-09-2021-GVWGWJOI4H.jpg', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor\r\n                                    incididunt.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor\r\n                                    incididunt.', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor\r\n                                    incididunt.', 8, 1, '2021-09-15 09:21:16', '2021-09-18 02:56:16'),
(3, 'scsbgnfnm', '1632322154-22-09-2021-GBW7MADUEI.jpg', 'vvdgdhrf', 'đvv', 9, 1, '2021-09-22 07:49:14', '2021-09-22 07:49:14'),
(4, 'What information is needed for shipping?', '1632322170-22-09-2021-ZIFSGWOCXS.jpg', 'ssgeg', 'xacs', 10, 1, '2021-09-22 07:49:30', '2021-09-22 07:49:30');
...
CREATE TABLE `tbl_brand` (
  ...
  `img_brand` varchar(250) NOT NULL,
  `status` smallint(6) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tbl_brand` (`id`, `brand_name`, `img_brand`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Panasonic', '1632969560-30-09-2021-T29XFMH3T4.jpg', 1, '2021-09-29 19:39:20', '2021-09-29 19:39:20'),
(2, 'Cannon', '1632969570-30-09-2021-1KQZNP63M9.png', 1, '2021-09-29 19:39:30', '2021-09-29 19:39:30'),
(3, 'Sony', '1632969580-30-09-2021-IARWZDKX68.png', 1, '2021-09-29 19:39:40', '2021-09-29 19:39:40'),
(4, 'Samsung', '1632969591-30-09-2021-CZNGDNXBT4.png', 1, '2021-09-29 19:39:51', '2021-09-29 19:39:51'),
(5, 'Bosch', '1632969630-30-09-2021-LSQZQH0TAJ.png', 1, '2021-09-29 19:40:30', '2021-09-29 19:40:30'),
(6, 'HP', '1632969670-30-09-2021-RSGH1ZHSEB.png', 1, '2021-09-29 19:41:10', '2021-09-29 19:41:10'),
(7, 'Dell', '1632969679-30-09-2021-OULA5S54LC.png', 1, '2021-09-29 19:41:19', '2021-09-29 19:41:19'),
(8, 'Yoosee', '1633534911-06-10-2021-BRRLVZPUKX.jpg', 1, '2021-10-06 08:41:51', '2021-10-06 08:41:51');
...
INSERT INTO `tbl_cart` (`id`, `pro_id`, `classify`, `type_id`, `price`, `price_sale`, `Quantity`, `cus_id`) VALUES
(10, 54, 6, 9, 4999000, 0, 1, 1),
(13, 21, 1, NULL, 100000, 80000, 1, 3);
...
INSERT INTO `tbl_category` (`id`, `cat_name`, `status`, `parden_id`, `typecat`, `created_at`, `updated_at`) VALUES
(8, 'Thiết bị điện tử', 1, 0, 2, '2021-09-02 08:58:56', '2021-10-05 08:49:03'),
(9, 'Máy tính và Phụ kiện', 1, 0, 2, '2021-09-03 06:47:41', '2021-10-07 01:51:20'),
(10, 'tivi', 1, 0, 2, '2021-09-03 06:52:10', '2021-10-05 08:50:13'),
(18, 'Điên thoại & Máy tính bảng', 1, 0, 2, '2021-10-05 09:09:39', '2021-10-07 01:28:40'),
(19, 'Tai nghe', 1, 0, 2, '2021-10-05 09:16:36', '2021-10-05 09:16:36'),
(20, 'Flycamera', 1, 0, 2, '2021-10-05 09:17:27', '2025-08-01 07:54:04'),
(21, 'Máy ảnh ,Hình ảnh & video', 1, 0, 2, '2021-10-05 09:19:30', '2021-10-05 09:19:30'),
(22, 'Mp3 players', 1, 8, 2, '2021-10-07 01:38:36', '2021-10-07 01:38:36');
...
(1, 'màu đen', 1, '2021-09-05 23:39:48', '2021-09-06 00:39:49'),
(3, 'màu đỏ', 1, '2021-09-06 02:23:46', '2021-09-06 02:23:46'),
(4, 'màu xanh', 1, '2021-09-06 02:23:50', '2021-09-06 02:23:50'),
(5, 'màu trắng', 1, '2021-09-06 02:23:54', '2021-09-06 02:23:54'),
(6, 'màu hồng', 1, '2021-09-06 02:24:00', '2021-09-06 02:24:00'),
(7, 'màu vàng', 1, '2021-10-06 07:14:23', '2021-10-06 07:14:23');
...
CREATE TABLE `tbl_comment` (
  ...
  `ND_comment` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tbl_customer` (`id`, `cus_name`, `cus_email`, `cus_phone`, `password`, `avatar`, `remember_token`, `token`, `status`, `created_at`, `updated_at`) VALUES
(1, 'phihuukien', 'phihuukien0807@gmail.com', '0982345623', '$2y$10$jQHeF5aq0YThJyclXXDuW.Ug6HkZtMXaSG8tSFsvGXGcF27g57NRG', '1633253943-03-10-2021-Z1RPRAVDLS.jpg', 'U80NDXPVt6GdoWfTq8Ek70OHyY75whhuFPYYRb4hpgUCDHBtFOQvLJcNHI4b', NULL, 1, '2021-10-03 02:39:03', '2021-10-03 02:40:20'),
(2, 'long', 'longpd@gmail.com', '444', '$2y$10$4KebgtbDVV6FjCiH36bqKuSYSJDOIzNqOlddas9Fo3pP6tx3rep1W', '1753971064-31-07-2025-KNF6ZEW5WC.jpg', NULL, 'HF9U98IJFP', 0, '2025-07-31 07:11:04', '2025-07-31 07:11:04'),
(3, 'longpd', 'hoangdaihai224@gmail.com', '444444444', '$2y$10$RwvPhaxKdNOwiWLVBjSTXO7RsiVdSAGAIMgf2h9RbiKJYKAOSM5dm', '1754059295-01-08-2025-IRUSFHVPZA.jpg', NULL, NULL, 1, '2025-08-01 07:41:35', '2025-08-01 07:41:58');
...
INSERT INTO `tbl_order` (`id`, `customer_id`, `order_name`, `order_email`, `order_phone`, `City`, `district`, `commune`, `Address`, `order_note`, `total_price`, `status`, `coupon`, `created_at`, `updated_at`) VALUES
(2, 1, 'phihuukien', 'phihuukien0807@gmail.com', '0982345623', 'Hà Nội', 'quốc oai', 'Hà Nội', 'Đồng Quangwfasgfasgsa d dx', 'câcqcvqac', 3500000, 1, NULL, '2021-10-06 20:05:27', '2021-10-06 20:05:27'),
(3, 3, 'Phạm Đức Long', 'longpd@bacninh.gov.vn', '0913339327', 'Bắc Ninh', 'Bắc Giang', 'Bắc Giang', '82 Hùng Vương', 'test', 1560000, 1, NULL, '2025-08-01 07:44:13', '2025-08-01 07:44:13'),
(4, 3, 'Nguyễn Đức Thức', 'thucnd@gmail.com', '66666', 'Bắc Ninh', 'Bắc Giang', 'Bắc Giang', 'Lục ngạn Bắc Ninh', 'test', 1874250, 1, NULL, '2025-08-01 08:04:51', '2025-08-01 08:04:51');
...
INSERT INTO `tbl_orderdetail` (`order_id`, `product_id`, `price`, `Quantity`, `classfy`, `type_id`, `created_at`, `updated_at`) VALUES
(2, 40, 3500000, 1, NULL, NULL, '2021-10-06 20:05:27', '2021-10-06 20:05:27'),
(3, 47, 1560000, 1, 1, NULL, '2025-08-01 07:44:13', '2025-08-01 07:44:13'),
(4, 42, 1874250, 1, 1, NULL, '2025-08-01 08:04:51', '2025-08-01 08:04:51');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_procolor`
--
...
--
-- Đang đổ dữ liệu cho bảng `tbl_procolor`
--

INSERT INTO `tbl_procolor` (`id`, `pro_id`, `color_id`, `created_at`, `updated_at`) VALUES
(81, 21, 1, '2021-10-06 07:26:23', '2021-10-06 07:26:23'),
(82, 21, 3, '2021-10-06 07:26:23', '2021-10-06 07:26:23'),
(83, 21, 6, '2021-10-06 07:26:23', '2021-10-06 07:26:23'),
(84, 21, 5, '2021-10-06 07:26:23', '2021-10-06 07:26:23'),
(85, 21, 7, '2021-10-06 07:26:23', '2021-10-06 07:26:23'),
(86, 21, 4, '2021-10-06 07:26:23', '2021-10-06 07:26:23'),
(87, 22, 1, '2021-10-06 07:37:08', '2021-10-06 07:37:08'),
(88, 22, 3, '2021-10-06 07:37:08', '2021-10-06 07:37:08'),
(89, 22, 6, '2021-10-06 07:37:08', '2021-10-06 07:37:08'),
(90, 22, 5, '2021-10-06 07:37:08', '2021-10-06 07:37:08'),
(91, 23, 3, '2021-10-06 07:39:26', '2021-10-06 07:39:26'),
(92, 23, 6, '2021-10-06 07:39:26', '2021-10-06 07:39:26'),
(93, 23, 4, '2021-10-06 07:39:26', '2021-10-06 07:39:26'),
(94, 24, 1, '2021-10-06 07:51:27', '2021-10-06 07:51:27'),
(95, 24, 5, '2021-10-06 07:51:27', '2021-10-06 07:51:27'),
(96, 24, 7, '2021-10-06 07:51:27', '2021-10-06 07:51:27'),
(97, 25, 1, '2021-10-06 07:55:33', '2021-10-06 07:55:33'),
(98, 25, 3, '2021-10-06 07:55:33', '2021-10-06 07:55:33'),
(99, 25, 4, '2021-10-06 07:55:33', '2021-10-06 07:55:33'),
(100, 26, 1, '2021-10-06 08:03:32', '2021-10-06 08:03:32'),
(101, 26, 6, '2021-10-06 08:03:32', '2021-10-06 08:03:32'),
(102, 26, 5, '2021-10-06 08:03:32', '2021-10-06 08:03:32'),
(103, 27, 1, '2021-10-06 08:12:00', '2021-10-06 08:12:00'),
(104, 27, 6, '2021-10-06 08:12:00', '2021-10-06 08:12:00'),
(105, 27, 5, '2021-10-06 08:12:00', '2021-10-06 08:12:00'),
(106, 28, 1, '2021-10-06 08:25:09', '2021-10-06 08:25:09'),
(107, 28, 3, '2021-10-06 08:25:09', '2021-10-06 08:25:09'),
(108, 28, 5, '2021-10-06 08:25:09', '2021-10-06 08:25:09'),
(109, 28, 4, '2021-10-06 08:25:09', '2021-10-06 08:25:09'),
(110, 29, 1, '2021-10-06 08:33:15', '2021-10-06 08:33:15'),
(111, 29, 6, '2021-10-06 08:33:15', '2021-10-06 08:33:15'),
(112, 29, 5, '2021-10-06 08:33:15', '2021-10-06 08:33:15'),
(113, 29, 7, '2021-10-06 08:33:15', '2021-10-06 08:33:15'),
(114, 30, 1, '2021-10-06 08:57:36', '2021-10-06 08:57:36'),
(115, 30, 5, '2021-10-06 08:57:36', '2021-10-06 08:57:36'),
(116, 31, 1, '2021-10-06 09:07:27', '2021-10-06 09:07:27'),
(117, 31, 5, '2021-10-06 09:07:27', '2021-10-06 09:07:27'),
(118, 31, 7, '2021-10-06 09:07:27', '2021-10-06 09:07:27'),
(119, 32, 1, '2021-10-06 09:13:02', '2021-10-06 09:13:02'),
(120, 32, 5, '2021-10-06 09:13:02', '2021-10-06 09:13:02'),
(121, 33, 1, '2021-10-06 09:15:36', '2021-10-06 09:15:36'),
(122, 33, 5, '2021-10-06 09:15:36', '2021-10-06 09:15:36'),
(123, 34, 1, '2021-10-06 09:17:21', '2021-10-06 09:17:21'),
(124, 34, 3, '2021-10-06 09:17:21', '2021-10-06 09:17:21'),
(125, 34, 5, '2021-10-06 09:17:21', '2021-10-06 09:17:21'),
(126, 36, 1, '2021-10-06 09:24:17', '2021-10-06 09:24:17'),
(127, 36, 5, '2021-10-06 09:24:17', '2021-10-06 09:24:17'),
(128, 37, 1, '2021-10-06 09:26:49', '2021-10-06 09:26:49'),
(129, 37, 5, '2021-10-06 09:26:49', '2021-10-06 09:26:49'),
(130, 39, 1, '2021-10-06 09:30:48', '2021-10-06 09:30:48'),
(131, 39, 5, '2021-10-06 09:30:48', '2021-10-06 09:30:48'),
(132, 42, 1, '2021-10-07 01:09:16', '2021-10-07 01:09:16'),
(133, 42, 3, '2021-10-07 01:09:16', '2021-10-07 01:09:16'),
(134, 42, 6, '2021-10-07 01:09:16', '2021-10-07 01:09:16'),
(135, 42, 5, '2021-10-07 01:09:16', '2021-10-07 01:09:16'),
(136, 43, 1, '2021-10-07 01:12:25', '2021-10-07 01:12:25'),
(137, 43, 6, '2021-10-07 01:12:25', '2021-10-07 01:12:25'),
(138, 43, 5, '2021-10-07 01:12:25', '2021-10-07 01:12:25'),
(139, 44, 1, '2021-10-07 01:14:28', '2021-10-07 01:14:28'),
(140, 44, 4, '2021-10-07 01:14:28', '2021-10-07 01:14:28'),
(141, 45, 1, '2021-10-07 01:18:47', '2021-10-07 01:18:47'),
(142, 45, 3, '2021-10-07 01:18:48', '2021-10-07 01:18:48'),
(143, 45, 4, '2021-10-07 01:18:48', '2021-10-07 01:18:48'),
(144, 46, 3, '2021-10-07 01:20:41', '2021-10-07 01:20:41'),
(145, 46, 6, '2021-10-07 01:20:41', '2021-10-07 01:20:41'),
(146, 46, 5, '2021-10-07 01:20:41', '2021-10-07 01:20:41'),
(147, 47, 1, '2021-10-07 01:23:08', '2021-10-07 01:23:08'),
(148, 47, 6, '2021-10-07 01:23:08', '2021-10-07 01:23:08'),
(149, 48, 1, '2021-10-07 01:26:32', '2021-10-07 01:26:32'),
(150, 48, 3, '2021-10-07 01:26:32', '2021-10-07 01:26:32'),
(151, 48, 5, '2021-10-07 01:26:32', '2021-10-07 01:26:32'),
(152, 49, 1, '2021-10-07 01:27:50', '2021-10-07 01:27:50'),
(153, 49, 6, '2021-10-07 01:27:50', '2021-10-07 01:27:50'),
(154, 50, 1, '2021-10-07 01:41:46', '2021-10-07 01:41:46'),
(155, 50, 6, '2021-10-07 01:41:46', '2021-10-07 01:41:46'),
(156, 51, 1, '2021-10-07 01:46:41', '2021-10-07 01:46:41'),
(157, 51, 5, '2021-10-07 01:46:41', '2021-10-07 01:46:41'),
(158, 52, 1, '2021-10-07 01:48:15', '2021-10-07 01:48:15'),
(159, 52, 3, '2021-10-07 01:48:15', '2021-10-07 01:48:15'),
(160, 53, 1, '2021-10-07 01:56:09', '2021-10-07 01:56:09'),
(161, 53, 3, '2021-10-07 01:56:09', '2021-10-07 01:56:09'),
(162, 54, 6, '2021-10-07 02:00:37', '2021-10-07 02:00:37'),
(163, 54, 5, '2021-10-07 02:00:37', '2021-10-07 02:00:37'),
(164, 55, 1, '2021-10-07 09:14:56', '2021-10-07 09:14:56'),
(165, 55, 5, '2021-10-07 09:14:56', '2021-10-07 09:14:56');
...
--
-- Đang đổ dữ liệu cho bảng `tbl_productimg`
--

INSERT INTO `tbl_productimg` (`id`, `name_img`, `product_id`, `created_at`, `updated_at`) VALUES
(6, '1633530383-0-06-10-2021-UZ55B7NJQN.jpg', 21, '2021-10-06 07:26:23', '2021-10-06 07:26:23'),
(7, '1633530383-1-06-10-2021-SPMC9A9ZHV.jpg', 21, '2021-10-06 07:26:23', '2021-10-06 07:26:23'),
(8, '1633530383-2-06-10-2021-OEEYK6WXDS.jpg', 21, '2021-10-06 07:26:23', '2021-10-06 07:26:23'),
(9, '1633530383-3-06-10-2021-3DX9ZZTMTZ.jpg', 21, '2021-10-06 07:26:23', '2021-10-06 07:26:23'),
(10, '1633531028-0-06-10-2021-XT8F52IEJG.jpg', 22, '2021-10-06 07:37:08', '2021-10-06 07:37:08'),
(11, '1633531028-1-06-10-2021-XIH1PDEMKH.jpg', 22, '2021-10-06 07:37:08', '2021-10-06 07:37:08'),
(12, '1633531028-2-06-10-2021-6VDZT3EHDT.jpg', 22, '2021-10-06 07:37:08', '2021-10-06 07:37:08'),
(13, '1633531028-3-06-10-2021-EKTPCXY9JD.jpg', 22, '2021-10-06 07:37:08', '2021-10-06 07:37:08'),
(14, '1633531166-0-06-10-2021-PE3UD7ZT5V.jpg', 23, '2021-10-06 07:39:26', '2021-10-06 07:39:26'),
(15, '1633531166-1-06-10-2021-T9TEWLVXSR.jpg', 23, '2021-10-06 07:39:26', '2021-10-06 07:39:26'),
(84, '1633596106-1-07-10-2021-ZEJAUUVACP.jpg', 50, '2021-10-07 01:41:46', '2021-10-07 01:41:46'),
(85, '1633596401-0-07-10-2021-GZSVFIIDYY.jpg', 51, '2021-10-07 01:46:41', '2021-10-07 01:46:41'),
(86, '1633596401-1-07-10-2021-XT057I4JZZ.jpg', 51, '2021-10-07 01:46:41', '2021-10-07 01:46:41'),
(87, '1633596495-0-07-10-2021-2NFZRAJ1BG.jpg', 52, '2021-10-07 01:48:15', '2021-10-07 01:48:15'),
(88, '1633596495-1-07-10-2021-1ALEYXNHCW.jpg', 52, '2021-10-07 01:48:15', '2021-10-07 01:48:15'),
(89, '1633596495-2-07-10-2021-HLLXPRQJNJ.jpg', 52, '2021-10-07 01:48:15', '2021-10-07 01:48:15'),
(90, '1633596969-0-07-10-2021-HDT2BLETIZ.jpg', 53, '2021-10-07 01:56:09', '2021-10-07 01:56:09'),
(91, '1633596969-1-07-10-2021-GRAVIR30RH.jpg', 53, '2021-10-07 01:56:09', '2021-10-07 01:56:09'),
(92, '1633596969-2-07-10-2021-GJKE6AZXCP.jpg', 53, '2021-10-07 01:56:09', '2021-10-07 01:56:09'),
(93, '1633597237-0-07-10-2021-Q1APITNKCP.jpg', 54, '2021-10-07 02:00:37', '2021-10-07 02:00:37'),
(94, '1633597237-1-07-10-2021-SQWHATK5NC.jpg', 54, '2021-10-07 02:00:37', '2021-10-07 02:00:37'),
(95, '1633597237-2-07-10-2021-EJKUUHQXCN.jpg', 54, '2021-10-07 02:00:37', '2021-10-07 02:00:37'),
(96, '1633623296-0-07-10-2021-CDIDASEPPO.jpg', 55, '2021-10-07 09:14:56', '2021-10-07 09:14:56'),
(97, '1633623296-1-07-10-2021-ELILREF5T6.jpg', 55, '2021-10-07 09:14:56', '2021-10-07 09:14:56'),
(98, '1633623296-2-07-10-2021-MPPW5PQDNJ.jpg', 55, '2021-10-07 09:14:56', '2021-10-07 09:14:56'),
(99, '1633623296-3-07-10-2021-GLSRJCGQCH.jpg', 55, '2021-10-07 09:14:56', '2021-10-07 09:14:56'),
(100, '1633623296-4-07-10-2021-JR6PNITXY4.jpg', 55, '2021-10-07 09:14:56', '2021-10-07 09:14:56');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_protype`
--
...
--
-- Đang đổ dữ liệu cho bảng `tbl_protype`
--

INSERT INTO `tbl_protype` (`id`, `pro_id`, `type_id`, `created_at`, `updated_at`) VALUES
(1, 30, 1, '2021-10-06 08:57:36', '2021-10-06 08:57:36'),
(2, 30, 2, '2021-10-06 08:57:36', '2021-10-06 08:57:36'),
(3, 30, 3, '2021-10-06 08:57:36', '2021-10-06 08:57:36'),
(4, 31, 1, '2021-10-06 09:07:27', '2021-10-06 09:07:27'),
(5, 31, 2, '2021-10-06 09:07:27', '2021-10-06 09:07:27'),
(6, 31, 3, '2021-10-06 09:07:27', '2021-10-06 09:07:27'),
(7, 32, 1, '2021-10-06 09:13:02', '2021-10-06 09:13:02'),
(8, 32, 2, '2021-10-06 09:13:02', '2021-10-06 09:13:02'),
(9, 32, 3, '2021-10-06 09:13:02', '2021-10-06 09:13:02'),
(10, 33, 1, '2021-10-06 09:15:36', '2021-10-06 09:15:36'),
(11, 33, 2, '2021-10-06 09:15:36', '2021-10-06 09:15:36'),
(12, 33, 3, '2021-10-06 09:15:36', '2021-10-06 09:15:36'),
(13, 51, 6, '2021-10-07 01:46:41', '2021-10-07 01:46:41'),
(14, 51, 7, '2021-10-07 01:46:41', '2021-10-07 01:46:41'),
(15, 51, 8, '2021-10-07 01:46:41', '2021-10-07 01:46:41'),
(16, 52, 7, '2021-10-07 01:48:15', '2021-10-07 01:48:15'),
(17, 52, 8, '2021-10-07 01:48:15', '2021-10-07 01:48:15'),
(18, 54, 9, '2021-10-07 02:00:37', '2021-10-07 02:00:37'),
(19, 54, 10, '2021-10-07 02:00:37', '2021-10-07 02:00:37');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_reply`
--
...
INSERT INTO `tbl_type` (`id`, `cat_id`, `type`, `status`, `created_at`, `updated_at`) VALUES
(1, 21, 'camera không ảnh', 1, '2021-09-29 19:43:56', '2021-10-06 08:51:20'),
(2, 21, 'camere thẻ 23 GB', 1, '2021-09-29 19:44:02', '2021-10-06 08:51:33'),
(3, 21, 'camere kèm thẻ 64 GB', 1, '2021-09-29 19:44:10', '2021-10-06 08:51:29'),
(6, 22, '853 -The-Tn- 8G+sạc', 1, '2021-10-07 01:44:37', '2021-10-07 01:44:37'),
(7, 22, '853 -The-Tn- 8G', 1, '2021-10-07 01:45:04', '2021-10-07 01:45:04'),
(8, 22, '826s -The-Tn- 8G+sạc', 1, '2021-10-07 01:45:23', '2021-10-07 01:45:23'),
(9, 9, 'Bộ pc thường 99%', 1, '2021-10-07 01:58:34', '2021-10-07 01:58:34'),
(10, 9, 'Bộ pc game-led 99%', 1, '2021-10-07 01:59:04', '2021-10-07 01:59:04');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_useradmin`
--
...
--
-- Đang đổ dữ liệu cho bảng `tbl_useradmin`
--

INSERT INTO `tbl_useradmin` (`id`, `user_name`, `user_email`, `user_phone`, `password`, `avatar`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'admin', 'admin@gmail.com', '0964257392', '$2y$10$dOotjcXfInchiMTUqkLIyO1bR0tcGqVo8Lqc8wdu/q93eo6EcE/mi', '1753970913-31-07-2025-2GKNLEF8MT.jpg', NULL, 'RCrUo6kSSDDr0iGeOSTxkA9fH9RZaCrhzGp2XCSS8FX840zIzDh0XIDDm7Vz', '2021-09-04 06:37:30', '2025-07-31 07:08:33'),
(2, 'cuonghd', 'cuonghd@gmail.com', '0913339327', '$2y$10$dOotjcXfInchiMTUqkLIyO1bR0tcGqVo8Lqc8wdu/q93eo6EcE/mi', 'face1.jpg', NULL, 'm3yH0C1WV5sio92xYVVqdy3C052vN3bjZJFwVfrG14RSeKbyyOYwhHzgFF4O', '2021-09-29 18:38:01', '2021-09-29 18:38:01');
...
ALTER TABLE `tbl_blog`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tbl_blog_category_foreign` (`category`);
...
ALTER TABLE `tbl_cart`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tbl_cart_pro_id_foreign` (`pro_id`);
...
ALTER TABLE `tbl_comment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tbl_comment_id_customer_foreign` (`id_customer`),
  ADD KEY `tbl_comment_id_blog_foreign` (`id_blog`);
...
ALTER TABLE `tbl_customer`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `tbl_customer_cus_email_unique` (`cus_email`),
  ADD UNIQUE KEY `tbl_customer_cus_phone_unique` (`cus_phone`);
...
ALTER TABLE `tbl_favorite`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tbl_favorite_cus_id_foreign` (`cus_id`),
  ADD KEY `tbl_favorite_pro_id_foreign` (`pro_id`);
...
ALTER TABLE `tbl_orderdetail`
  ...
  ADD KEY `tbl_orderdetail_product_id_foreign` (`product_id`);

--
-- Chỉ mục cho bảng `tbl_procolor`
--
ALTER TABLE `tbl_procolor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tbl_procolor_pro_id_forenign` (`pro_id`),
  ADD KEY `tbl_procolor_color_id_forenign` (`color_id`);
...
ALTER TABLE `tbl_product`
  ...
  ADD KEY `tbl_product_id_brands_foreign` (`id_brands`);

--
-- Chỉ mục cho bảng `tbl_productimg`
--
ALTER TABLE `tbl_productimg`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tbl_productimg_product_id_foreign` (`product_id`);

--
-- Chỉ mục cho bảng `tbl_protype`
--
ALTER TABLE `tbl_protype`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tbl_protype_pro_id_foreign` (`pro_id`),
  ADD KEY `tb-_protype_type_id_foreign` (`type_id`);

--
-- Chỉ mục cho bảng `tbl_reply`
--
ALTER TABLE `tbl_reply`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tbl_reply_comment_id_foreign` (`comment_id`),
  ADD KEY `tbl_reply_cus_id_foreign` (`cus_id`);
...
--
-- Chỉ mục cho bảng `tbl_useradmin`
--
ALTER TABLE `tbl_useradmin`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `tbl_useradmin_user_email_unique` (`user_email`);
...
--
-- AUTO_INCREMENT cho bảng `tbl_procolor`
--
ALTER TABLE `tbl_procolor`
...
--
-- AUTO_INCREMENT cho bảng `tbl_productimg`
--
ALTER TABLE `tbl_productimg`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT cho bảng `tbl_protype`
--
ALTER TABLE `tbl_protype`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT cho bảng `tbl_reply`
--
ALTER TABLE `tbl_reply`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `tbl_useradmin`
--
ALTER TABLE `tbl_useradmin`
...
--
ALTER TABLE `tbl_blog`
  ADD CONSTRAINT `tbl_blog_category_foreign` FOREIGN KEY (`category`) REFERENCES `tbl_category` (`id`);

--
-- Các ràng buộc cho bảng `tbl_cart`
--
ALTER TABLE `tbl_cart`
  ADD CONSTRAINT `tbl_cart_pro_id_foreign` FOREIGN KEY (`pro_id`) REFERENCES `tbl_product` (`id`);

--
-- Các ràng buộc cho bảng `tbl_comment`
--
ALTER TABLE `tbl_comment`
  ADD CONSTRAINT `tbl_comment_id_blog_foreign` FOREIGN KEY (`id_blog`) REFERENCES `tbl_blog` (`id`),
  ADD CONSTRAINT `tbl_comment_id_customer_foreign` FOREIGN KEY (`id_customer`) REFERENCES `tbl_customer` (`id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_favorite`
--
ALTER TABLE `tbl_favorite`
  ADD CONSTRAINT `tbl_favorite_cus_id_foreign` FOREIGN KEY (`cus_id`) REFERENCES `tbl_customer` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `tbl_favorite_pro_id_foreign` FOREIGN KEY (`pro_id`) REFERENCES `tbl_product` (`id`);

--
-- Các ràng buộc cho bảng `tbl_order`
--
ALTER TABLE `tbl_order`
  ADD CONSTRAINT `tbl_order_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `tbl_customer` (`id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_orderdetail`
--
ALTER TABLE `tbl_orderdetail`
  ADD CONSTRAINT `tbl_orderdetail_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`id`),
  ADD CONSTRAINT `tbl_orderdetail_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `tbl_product` (`id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_procolor`
--
ALTER TABLE `tbl_procolor`
  ADD CONSTRAINT `tbl_procolor_color_id_forenign` FOREIGN KEY (`color_id`) REFERENCES `tbl_color` (`id`),
  ADD CONSTRAINT `tbl_procolor_pro_id_forenign` FOREIGN KEY (`pro_id`) REFERENCES `tbl_product` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `tbl_product`
  ...
  ADD CONSTRAINT `tbl_product_id_brands_foreign` FOREIGN KEY (`id_brands`) REFERENCES `tbl_brand` (`id`);

--
-- Các ràng buộc cho bảng `tbl_productimg`
--
ALTER TABLE `tbl_productimg`
  ADD CONSTRAINT `tbl_productimg_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `tbl_product` (`id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_protype`
--
ALTER TABLE `tbl_protype`
  ADD CONSTRAINT `tb-_protype_type_id_foreign` FOREIGN KEY (`type_id`) REFERENCES `tbl_type` (`id`),
  ADD CONSTRAINT `tbl_protype_pro_id_foreign` FOREIGN KEY (`pro_id`) REFERENCES `tbl_product` (`id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_reply`
--
ALTER TABLE `tbl_reply`
  ADD CONSTRAINT `tbl_reply_comment_id_foreign` FOREIGN KEY (`comment_id`) REFERENCES `tbl_comment` (`id`),
  ADD CONSTRAINT `tbl_reply_cus_id_foreign` FOREIGN KEY (`cus_id`) REFERENCES `tbl_customer` (`id`);

--
-- Các ràng buộc cho bảng `tbl_user_roles`
--
ALTER TABLE `tbl_user_roles`
  ADD CONSTRAINT `tbl_user_roles_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `tbl_roles` (`id`),
  ADD CONSTRAINT `tbl_user_roles_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `tbl_useradmin` (`id`);
COMMIT;
