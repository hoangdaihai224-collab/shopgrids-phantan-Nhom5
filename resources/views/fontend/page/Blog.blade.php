                        ...
                        <div class="single-blog">
                            <div class="blog-img">
                                <a href="blog-single-sidebar.html">
                                    <img src="{!! asset('bog/'.$blog->blog_image) !!}" alt="#">
                                </a>
                            </div>
                            <div class="blog-content">
                                <a class="category" href="javascript:void(0)">{{$blog->cat ? $blog->cat->cat_name :""}}</a>
                                <h4>
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt.</p>
                                <div class="button">
                                    <a href="{{route('Blogdetail',$blog->id)}}" class="btn">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="single-popular-feed">
                                <div class="feed-desc">
                                    <a class="feed-img" href="blog-single-sidebar.html">
                                        <img src="{{ URL::asset('assets/fontend/images/blog/blog-sidebar-1.jpg') }}" alt="#">
                                    </a>
