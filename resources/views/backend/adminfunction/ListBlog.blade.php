                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{!! asset('bog/'.$blog->blog_image) !!}"
                                                style="border-radius:5px;  width:100px; height:60px;"></td>
                                                <td>{{$blog->cat ? $blog->cat->cat_name :""}}</td>

                                   
                                        <td class="py-1">{{ $blog->status== "1" ? 'Còn Hàng' : 'Hết Hàng'}}</td>

                                        <td>
                                            <form action="{{route('admin.delete.bog' ,  $blog->id)}}" method="POST">
                                                 @method('DELETE') @csrf 
                                                <a href="{{route('admin.edit.blog' ,  $blog->id)}}" class="text-dark"
